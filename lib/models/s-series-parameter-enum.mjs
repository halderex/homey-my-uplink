...
const SSeriesParameterIds = {
    ...
    LIQUID_LINE: 17,
    SUCTION_GAS: 19,
    CALCULATED_SUPPLY_LINE: 1708,  // Calculated supply line, climate system 1
    AIRFLOW: 26945,                // Airflow (BP16)
    ...
    ADD_HEAT_TIME_HEATING: 26411,  // Op. time el. add. heat for heating (h)
    ...
    INTERNAL_ADD_HEAT_POWER: 1756, // Power internal additional heat (kW)
